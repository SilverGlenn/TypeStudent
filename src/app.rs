...
impl TypeStudentView {
                                                        ...
                                                        div()
                                                            ...
                                                            .child(
                                                                div()
                                                                    ...
                                                                    .items_center()
                                                                    .gap_1p5()
                                                                    .child(div().text_size(px(12.0)).child(ex.exercise_type.icon()))
                                                                    .child(
                                                                        div()
                                                                            .text_size(px(12.0))
                                                                            .font_weight(FontWeight::SEMIBOLD)
    ...
    // 2. Live Interactive Typing Arena (Unified Deck Layout)
    fn render_typing_arena(&self, _cx: &mut Context<Self>) -> AnyElement {
        ...
        div()
            ...
            // Typing Text Box Area (Spacious, large clear font)
            .child(
                div()
                    .p_4()
                    .rounded_xl()
            ...
            // Combined Keyboard & Hands Guidance Deck (Unified Console)
            .child(
                div()
                    .p_4()
                    .rounded_2xl()
                    ...
                    // Visual Hands Guide (Directly under keyboard)
                    .child(
    ...
    // Visual Keyboard Component (Color-Coded Finger Zones with Tactile Home Row Dots)
    ...
    // Authentic Hand Shapes & Animated Finger Guides
                ...
                div()
                    ...
                    .child(
                        if difficult_keys.is_empty() {
                            div().text_size(px(12.0)).text_color(rgb(0x15803d)).child("✨ No weak keys detected! Your accuracy is great across all tested keys.")
                        } else {
                            div()
                                .flex()
                                .gap_2p5()
                                    ...
                                    div()
                                        ...
                                        .child(
                                            div()
                                                ...
                                                .text_color(rgb(0x64748b))
                                                .line_height(px(16.0))
                                                .child(format!("{}...", &story.content[..story.content.len().min(80)]))
                                        )
                                )
                                .child(
                                    div()
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .flex_col()
                            .items_center()
                            .child(div().text_size(px(20.0)).font_weight(FontWeight::BOLD).child(format!("{:.1} WPM", diploma.net_wpm)))
                    ...
                    .child(
                        div()
                            ...
                            .flex_col()
                            .items_center()
                            .child(div().text_size(px(20.0)).font_weight(FontWeight::BOLD).child(format!("{:.1}%", diploma.accuracy)))
                    ...
                    .child(
                        div()
                            ...
                            .flex_col()
                            .items_center()
                            .child(div().text_size(px(20.0)).font_weight(FontWeight::BOLD).child(diploma.duration_label.clone()))
            ...
            .child(
                div()
                    ...
                    .children(export_msg.map(|msg| {
                        div().text_size(px(11.0)).font_weight(FontWeight::BOLD).text_color(rgb(0x15803d)).child(format!("✓ Certificate exported to {}", msg))
                    }))
            )
            .into_any_element()
    }
        ...
        div()
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .items_center()
                            .gap_3()
                            .child(div().text_size(px(13.0)).font_weight(FontWeight::BOLD).text_color(rgb(0xd97706)).child(format!("Score: {}", game.score)))
                            .child(div().text_size(px(13.0)).font_weight(FontWeight::BOLD).text_color(rgb(0x0284c7)).child(format!("Streak: {}", game.streak)))
                            .child(div().text_size(px(13.0)).text_color(rgb(0xdc2626)).child(format!("Lives: {}", "❤️".repeat(game.lives as usize))))
                    )
            )
            .child(
                div()
            ...
            .child(
                div()
                    ...
                    .justify_between()
                    .child(
                        div().text_size(px(11.0)).text_color(rgb(0x64748b)).child("Type the letter or word in the bubble to pop it before it reaches the floor!")
                    )
                    .child(
                        div()
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .gap_3()
                            .child(div().text_size(px(13.0)).font_weight(FontWeight::BOLD).text_color(rgb(0xd97706)).child(format!("Score: {}", game.score)))
                            .child(div().text_size(px(13.0)).font_weight(FontWeight::BOLD).text_color(rgb(0x0284c7)).child(format!("Cleared: {}", game.lines_cleared)))
                    )
            )
            .child(
                div()
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .gap_3()
                            .child(div().text_size(px(13.0)).font_weight(FontWeight::BOLD).text_color(rgb(0xd97706)).child(format!("Score: {}", game.score)))
                            .child(div().text_size(px(13.0)).font_weight(FontWeight::BOLD).text_color(rgb(0xdc2626)).child(format!("Misses: {}/5", game.misses)))
                    )
            )
            .child(
                div()
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .child(div().text_size(px(12.0)).text_color(rgb(0x64748b)).child("Type A to Z as fast as humanly possible!"))
            )
            .child(
                div()
                    .flex()
                    ...
                    .border_color(rgb(0x38bdf8))
                    .gap_1()
                    .child(div().text_size(px(12.0)).text_color(rgb(0x64748b)).child("STRIKE NEXT LETTER"))
                    .child(
                        div()
                            .text_size(px(54.0))
                            .font_weight(FontWeight::BOLD)
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    .flex()
                                    .flex_col()
                                    .child(div().text_size(px(13.5)).font_weight(FontWeight::BOLD).child("Procedural Sound Effects"))
                                    .child(div().text_size(px(11.0)).text_color(rgb(0x64748b)).child("Mechanical keyclicks, chimes, and mistake thuds"))
                            )
                            .child(
                                div()
                                    .id("toggle_sound_btn")
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    .flex()
                                    .flex_col()
                                    .child(div().text_size(px(13.5)).font_weight(FontWeight::BOLD).child("Target Speed Goal"))
                                    .child(div().text_size(px(11.0)).text_color(rgb(0x64748b)).child("Benchmark speed used for 5-star calculations"))
                            )
                            .child(
                                div()
                                    .px_3p5()
